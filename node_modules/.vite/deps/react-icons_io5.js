...
function Tree2Element(tree) {
  return tree && tree.map((node, i) => Rn.createElement(node.tag, _objectSpread({
    key: i
  }, node.attr), Tree2Element(node.child)));
}
function GenIcon(data) {
  return (props) => Rn.createElement(IconBase, _extends({
...
function IconBase(props) {
  var elem = (conf) => {
    ...
    return Rn.createElement("svg", _extends({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
  ...
  return IconContext !== void 0 ? Rn.createElement(IconContext.Consumer, null, (conf) => elem(conf)) : elem(DefaultContext);
}
