import {
  Rn,
  init_compat_module
} from "./chunk-TPJZPHJ5.js";
import {
  A,
  h,
  y
} from "./chunk-T7QRG7BP.js";
import "./chunk-T2PA3PEZ.js";
import {
  __commonJS,
  __toESM
...
init_compat_module();
function s(c = null) {
  let [e, f] = Rn.useState(c);
  const { current: r } = Rn.useRef({
    current: e
  });
...
init_compat_module();
function o(t, u = { isStateful: true }) {
  const n = s(null), f = A(null), e = u.isStateful ? n : f;
  return Rn.useEffect(() => {
...
var CloseIcon = function CloseIcon2(_ref) {
  ...
  return Rn.createElement("button", {
    id,
  ...
  }, closeIcon ? closeIcon : Rn.createElement("svg", {
...
var Modal = Rn.forwardRef(function(_ref, ref) {
  ...
  var refDialog = o(ref);
  var refModal = A(null);
  var refShouldClose = A(null);
  var refContainer = A(null);
  if (refContainer.current === null && isBrowser) {
    refContainer.current = document.createElement("div");
  }
  var _useState = h(false), showPortal = _useState[0], setShowPortal = _useState[1];
  ...
  return showPortal && containerModal ? Rn.createPortal(Rn.createElement("div", {
    ...
    "data-testid": "modal",
    tabIndex: -1
  }, focusTrapped && Rn.createElement(FocusTrap, {
    container: refDialog,
    initialFocusRef
  }), children, showCloseIcon && Rn.createElement(CloseIcon, {
    classes,
    classNames,
    styles,
    closeIcon,
